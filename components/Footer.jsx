...
function Footer() {
  return (
    <footer className='flex flex-col items-center justify-center bg-primary-10 text-white relative py-12 font-medium md:flex-row md:justify-between w-screen md:h-[300px] md:items-start pb-10 md:px-10 md:py-14 max-w-6x mx-auto'>
      {/* <HorLine /> */}
