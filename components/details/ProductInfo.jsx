  ...
  return (
    <section className='p-4 '>
      ...
      <div className="flex justify-between items-center py-5">
       ...
       <p className="font-medium line-through text-sm text-secondary-7 animate-zoomInOut">{discountPrice}</p>
       <p className="font-bold bg-secondary-3 px-2 rounded-sm text-secondary-7">- {discountPercentage}</p>
      </div>
    </section>
  );
}
